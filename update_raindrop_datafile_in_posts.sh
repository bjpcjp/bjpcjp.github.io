...
# Expression to find and replace
OLD_EXPRESSION='{%- assign raindrop = site.data.raindrop.v20250411.rain20250419 %}'
NEW_EXPRESSION='{%- assign raindrop = site.data.raindrop.v20250419.rain20250419 %}'
